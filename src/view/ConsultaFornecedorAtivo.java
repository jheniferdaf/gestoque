...
public class ConsultaFornecedorAtivo extends javax.swing.JPanel {
    ...
    public ConsultaFornecedorAtivo(JPanel paineis, EditaFornecedor editaFornecedor) {
        initComponents();
    ...
    private void initComponents() {
        ...
        desativar.setBackground(new java.awt.Color(181, 212, 222));
        ...
        desativarLabel.setFont(new java.awt.Font("Decker", 0, 14)); // NOI18N
        desativarLabel.setForeground(new java.awt.Color(0, 8, 10));
        ...
        add(desativar, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 560, 80, 30));
    ...
    private void desativarLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_desativarLabelMouseClicked
        if (fornecedores.getSelectedIndex() != -1) {
            ...
            Fornecedor f = listaFornecedores.get(fornecedores.getSelectedIndex());
            int resposta = JOptionPane.showConfirmDialog(this, "Tem certeza que deseja desativar o " + f.getRazaoSocial()+ "?");
            if (resposta == JOptionPane.OK_OPTION) {
                ...
                JOptionPane.showMessageDialog(this, f.getRazaoSocial()+ " foi desativado.");
            }
